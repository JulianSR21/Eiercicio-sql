...
VALUES ('Julian David', 'protolito16@gmail.com', 21, 'Nazareth', 'Garzon', 1);
-- ? 2
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
VALUES ('carlos', 'carlitos@gmail.com', 17, 'Andes', 'Altamira', 1);
-- ? 3
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
VALUES ('lola lopez', 'lavacalola@gmail.com', 29, 'Cali', 'Garzon', 2);
-- ? 4
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
...
-- ? 8
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
VALUES ('wilson paz', 'wilsonpaz@gmail.com', 18, 'Calle 5 #12-1', 'Suaza', 2);
-- ? 9
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
...
-- ? 12
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
VALUES ('Leo Messi', 'Mesientomal@gmail.com', 10, '  ', 'Garzon', 1);
-- ? 13
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
VALUES ('Juan Sebastian', 'JuanSebastian@gmail.com', 29, 'Metro', 'Medellin', 1);
-- ? 14
INSERT INTO aprendices (nombre_apellido, correo, edad, direccion, ciudad, estado) 
...
--! CASO 2
--? SYNTAXIS ====> SELECT (columnas) FROM (tabla) WHERE (condicion)
SELECT * FROM aprendices WHERE correo = 'Mesientomal@gmail.com';
